<template>
  <div class="namida">
    ...
    <div v-show="showContent" class="container">
        <youtube :video-id="'Y0EcKR05Ac4'" ref="youtube" @playing="loaded()" :player-vars="playerVars" class="video"></youtube>
    </div>
    <br>
    <a href="https://www.youtube.com/watch?v=Y0EcKR05Ac4">Magical Doctor</a>
